...
> **Historical pre-meeting artifact.** This brief was prepared before the completed Krishnan meeting. It is preserved as research provenance and is not the current protocol or Saturday build plan. Post-meeting construct, evidence, and experiment decisions are in [`../hackathon/RESEARCH_METHODS_PROTOCOL_2026-07-16.md`](../hackathon/RESEARCH_METHODS_PROTOCOL_2026-07-16.md), [`../hackathon/SCOPUS_EVIDENCE_LEDGER_2026-07-16.md`](../hackathon/SCOPUS_EVIDENCE_LEDGER_2026-07-16.md), and [`../hackathon/SATURDAY_EXECUTION_PLAN_2026-07-18.md`](../hackathon/SATURDAY_EXECUTION_PLAN_2026-07-18.md). Do not use this artifact's claims or numbers without checking those superseding records.
...
**Validation status at the time of drafting.** The July 15 pass checked the sources listed in [`validation-log.md`](./validation-log.md) and repository claims against then-current `main`. The later post-meeting audit identified construct mismatches, context-only evidence, and claims needing primary-source revalidation. The post-meeting evidence ledger controls wherever the records differ.
