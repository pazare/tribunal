...
5. The current E2 does not establish general immunity to social conformity. It estimates susceptibility to a neutral, unsupported `3 of 4 other panelists` count cue in these fixtures, roles, prompts, and served models.
